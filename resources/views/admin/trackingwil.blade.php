        ...
        $(document).ready(function() {
            ...
            function filterTable() {
                ...
                $('table tbody tr').each(function() {
                    var noPO = $(this).find('td:nth-child(1)').text().toUpperCase();
                ...
                success: function(data) {
                    ...
                    if (data.pr.details.length == 0) {
                        ...
                        $.each(data.pr.details, function(key, value) {
                            ...
                            const belum_diterima_qc = value.belum_diterima_qc ? value
                                .belum_diterima_qc : '-';
                            const diterima_eks = value.diterima_eks ? value.diterima_eks : '-';
                            const belum_diterima_eks = value.belum_diterima_eks ? value
                                .belum_diterima_eks : '-';
                            ...
                            $('#table-pr').append('<tr><td>' + (key + 1) + '</td><td>' + value
                                ...
                                msg + date + '</b>' + '</b></td>' +
                                '<td style="min-width:200px">' + '<b>Sudah Diterima : &nbsp;' +
                                diterima_eks + '</b><br>' + '<b>Belum Diterima : &nbsp;' +
                                belum_diterima_eks + '</b></td>' +
                                '<td style="min-width:200px">' + '<b>Sudah Diterima : &nbsp;' +
                                diterima_qc + '</b><br>' + '<b>Belum Diterima : &nbsp;' +
                                belum_diterima_qc + '<br><b>OK : &nbsp;' + ok +
                                '<br><b>NOK : &nbsp;' + nok + '</b></td>' + '</td>' + '</tr>'
