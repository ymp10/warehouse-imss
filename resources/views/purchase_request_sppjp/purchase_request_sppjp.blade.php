...
@section('title', __('Purchase Request SPPJP'))
@section('custom-css')
    ...
    <section class="content">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add-pr"
                        onclick="addPR()"><i class="fas fa-plus"></i> Add SPPJP</button>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="filter-pr-no">Filter Nomor SPPJP</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="filter-pr-date">Filter Tanggal SPPJP</label>
                                    ...
                                    @foreach ($requests as $key => $d)
                                        @php
                                            $data = [
                                                ...
                                                'no_pr_sppjp' => $d->no_pr_sppjp,
                                                'proyek' => $d->proyek_name,
                                                'tanggal' => date('d/m/Y', strtotime($d->tgl_pr_sppjp)),
                                                'dasar_pr_sppjp' => $d->dasar_pr_sppjp,
                                        ...
                                        <tr>
                                            @if (Auth::user()->role == 2 && strpos(strtolower($data['no_pr_sppjp']), 'wil1') !== false)
                                                <td class="text-center"><input type="checkbox" name="hapus[]"
                                                        value="{{ $d->id }}"></td>


                                                {{-- <td class="text-center">{{ $data['no'] }}</td> --}}
                                                <td class="text-center">{{ $data['no_pr_sppjp'] }}</td>
                                                <td class="text-center">{{ $data['proyek'] }}</td>
                                                <td class="text-center">{{ $data['tanggal'] }}</td>
                                                <td class="text-center">{{ $data['dasar_pr_sppjp'] }}</td>
                                                <td class="text-center">
                                                @elseif (Auth::user()->role == 3 && strpos(strtolower($data['no_pr_sppjp']), 'wil2') !== false)
                                                <td class="text-center"><input type="checkbox" name="hapus[]"
                                                        value="{{ $d->id }}"></td>
                                                {{-- <td class="text-center">{{ $data['no'] }}</td> --}}
                                                <td class="text-center">{{ $data['no_pr_sppjp'] }}</td>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 id="modal-title" class="modal-title">{{ __('Add SPPJP') }}</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form role="form" id="save" action="{{ route('products.pr_sppjp.store') }}"
                            method="post">
                            @csrf
                            <input type="hidden" id="save_id" name="id">
                            <div class="form-group row">
                                <label for="no_pr_sppjp" class="col-sm-4 col-form-label">{{ __('Nomor SPPJP') }} </label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="no_pr_sppjp" name="no_pr_sppjp"
                                        autocomplete="off">
                                </div>
                            </div>
                            <!--<div class="form-group row">-->
                            ...
                            <!--</div>-->
                            <div class="form-group row">
                                <label for="tgl_pr_sppjp" class="col-sm-4 col-form-label">{{ __('Tanggal') }}
                                </label>
                                <div class="col-sm-8">
                                    {{-- <input type="date" class="form-control" id="tgl_pr" name="tgl_pr"
                                        min="{{ date('Y-m-d', strtotime('-7 days')) }}"> --}}

                                    <input type="date" class="form-control w-50" id="tgl_pr_sppjp"
                                        name="tgl_pr_sppjp">
                                </div>
                            </div>
                            <div class="form-group
                            ...
                            <div class="form-group row">
                                <label for="dasar_pr_sppjp" class="col-sm-4 col-form-label">{{ __('Nomor Kontrak') }}
                                </label>
                                <div class="col-sm-8">
                                    {{-- <input type="text" class="form-control" id="dasar" name="dasar"> --}}
                                    <textarea class="form-control" name="dasar_pr_sppjp" id="dasar_pr_sppjp" rows="3" readonly></textarea>
                                </div>
                            </div>
        ...
        <div class="modal fade" id="detail-pr">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 id="modal-title" class="modal-title">{{ __('Detail SPPJP') }}</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
...
@section('custom-js')
                ...
                if (proyek_id) {
                    $.ajax({
                        ...
                        success: function(response) {
                            $('#dasar_pr_sppjp').val(response.nomor_kontrak);
                        },
                        error: function() {
                            $('#dasar_pr_sppjp').val('');
                        }
    ...
    <script>
        ...
        function lihatSPPJP(data) {
            ...
            $('#button-tambah-produk').text('Tambah Item Detail');
            $('#id').val(data.id);
            $('#no_surat').text(data.no_pr_sppjp);
            ...
            $.ajax({
                url: "{{ url('products/purchase_request_detail_sppjp') }}" + "/" + data.id,
                type: "GET",
                dataType: "json",
                beforeSend: function() {
                    $('#table-pr').append('<tr><td colspan="15" class="text-center">Loading...</td></tr>');
