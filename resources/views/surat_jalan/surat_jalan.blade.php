    ...
    <section class="content">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add-sjn"
                        onclick="addSJN()"><i class="fas fa-plus"></i> Add Surat Jalan</button>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="filter-sjn-no">Filter Nomor Surat Jalan</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="filter-sjn-date">Filter Tanggal Surat Jalan</label>
                        ...
                        <table id="table" class="table table-sm table-bordered table-hover table-striped">
                            <thead>
                                <tr class="text-center">
                                    ...
                                    {{-- <th>No.</th> --}}
                                    <th>{{ __('Nomor Surat Jalan') }}</th>
                                    <th>{{ __('Tanggal Surat Jalan') }}</th>
                                    <th>{{ __('Kepada') }}</th>
                                    <th>{{ __('Lokasi') }}</th>
                                    <th>{{ __('Pengirim') }}</th>
                                    <th>{{ __('Note') }}</th>
                                    ...
                                    @foreach ($requests as $key => $d)
                                        @php
                                            $data = [
                                                ...
                                                'tanggal' => date('d/m/Y', strtotime($d->tgl_sjn)),
                                                'kepada' => $d->kepada,
                                                'lokasi' => $d->lokasi,
                                                'pengirim' => $d->pengirim,
                                                'note' => $d->note,
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">{{ $data['tanggal'] }}</td>
                                            <td class="text-center">{{ $data['kepada'] }}</td>

                                            <td class="text-center">{{ $data['lokasi'] }}</td>
                                            <td class="text-center">{{ $data['pengirim'] }}</td>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <button title="Edit SJN" type="button" class="btn btn-success btn-xs"
                                                    ...
                                                    onclick="editSJN({{ json_encode($data) }})"
                                                ...
                                                <button title="Hapus SJN" type="button" class="btn btn-danger btn-xs"
                                                    data-toggle="modal" data-target="#delete-sjn"
                                                    onclick="deleteSJN({{ json_encode($data) }})"
                                                    @if ($data['editable'] == 0) disabled @endif>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 id="modal-title" class="modal-title">{{ __('Add Surat Jalan') }}</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form role="form" id="save" action="{{ route('products.surat_jalan.store') }}"
                            method="post">
                            @csrf
                            ...
                            <div class="form-group row">
                                <label for="tgl_sjn" class="col-sm-4 col-form-label">{{ __('Tanggal') }}
                                </label>
                                <div class="col-sm-8">
                                    <input type="date" class="form-control" id="tgl_sjn" name="tgl_sjn"
                                        min="{{ date('Y-m-d', strtotime('-7 days')) }}">
                                </div>
                            </div>

                            <div class="form-group row">
                                <label for="kepada" class="col-sm-4 col-form-label">{{ __('Kepada') }}
                                </label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row">
                                <label for="lokasi" class="col-sm-4 col-form-label">{{ __('Lokasi') }}
                                </label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row">
                                <label for="pengirim" class="col-sm-4 col-form-label">{{ __('Pengirim') }}
                                </label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row">
                                <label for="note" class="col-sm-4 col-form-label">{{ __('Note') }}
                                </label>
                                <div class="col-sm-8">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12" id="container-form">
                                    ...
                                    <table class="align-top w-100">
                                        <tr>
                                            <td style="width: 3%;"><b>No SJN</b></td>
                                            <td style="width:2%">:</td>
                                ...
                                <div class="col-0 d-none" id="container-product">
                                    ...
                                    <div id="form" class="card">
                                        <div class="card-body">
                                            <form role="form" id="stock-update" method="post"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        ...
                                                        <input type="hidden" class="form-control" id="sjn_id"
                                                            disabled>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                            ...
                                            <button id="button-update-sjn" type="button"
        ...
        <div class="modal fade" id="delete-sjn">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 id="modal-title" class="modal-title">{{ __('Delete SJN') }}</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form role="form" id="delete" action="{{ route('surat_jalan.destroy') }}" method="post">
                            @csrf
                            @method('delete')
                            <input type="hidden" id="delete_id" name="id">
                        </form>
                        <div>
                            <p>Anda yakin ingin menghapus Surat Jalan ini <span id="pcode"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function filterTable() {
                ...
                $('table tbody tr').each(function() {
                    var noSJN = $(this).find('td:nth-child(2)').text().toUpperCase();
                    var dateSJN = $(this).find('td:nth-child(3)')
                    ...
                    var filterSJNDate = new Date(filterDateParts[0], filterDateParts[1] - 1,
                        filterDateParts[
        ...
        $('#delete-selected').click(function() {
            ...
            if (ids.length > 0) {
                ...
                $.ajax({
                    url: 'surat_jalan-imss/hapus-multiple',
                    type: 'POST',
                    data: {
                        _token: token,
                        ids: ids
        ...
        $('#detail-sjn').on('hidden.bs.modal', function() {
        ...
        function showAddProduct() {
            if ($('#detail-sjn').find('#container-product').hasClass('d-none')) {
                $('#detail-sjn').find('#container-product').removeClass('d-none');
                $('#detail-sjn').find('#container-product').addClass('col-5');
                $('#detail-sjn').find('#container-form').removeClass('col-12');
                $('#detail-sjn').find('#container-form').addClass('col-7');
                $('#button-tambah-produk').text('Kembali');
                $('#button-update-sjn').off('click');
                // Menambahkan event listener baru untuk menghandle klik pada tombol
                $('#button-update-sjn').text("Simpan").on('click', function() {
                ...
                $('#detail-sjn').find('#container-product').removeClass('col-5');
                $('#detail-sjn').find('#container-product').addClass('d-none');
                $('#detail-sjn').find('#container-form').addClass('col-12');
                $('#detail-sjn').find('#container-form').removeClass('col-7');
        ...
        function createData(formData) {
            $.ajax({
                url: "{{ url('products/update_surat_jalan_detail') }}",
                type: "POST",
                data: formData,
                contentType: false,
                processData: false,
                beforeSend: function() {
                    $('#table-sjn').append('<tr><td colspan="15" class="text-center">Loading...</td></tr>');
                ...
                success: function(data) {
                    ...
                    $('#tgl_surat').text(data.sjn.tanggal);
                    ...
                    if (data.sjn.details.length == 0) {
                        ...
                        $('#table-sjn').empty();
                        $.each(data.sjn.details, function(key, value) {
                            console.log(value)
                            var rowIndex = key + 1;
                            var editButton =
                                '<button type="button" class="btn btn-success btn-xs mr-1" data-row-id="' +
                                value.id + '" title="Edit" onclick="editRow(\'' + value.id + '\', \'' +
                                value.kode_material + '\', \'' + value.barang + '\', \'' + value
                                .spek + '\', \'' + value.qty +
                                '\', \'' + value.satuan + '\', \'' + value.keterangan +
                                '\')"><i class="fas fa-edit"></i></button>';


                            var deleteButton =
                                '<button type="button" class="btn btn-danger btn-xs mr-1"' +
                                ' onclick="deleteDetail(' + value.id + ', \'' + value.barang
                                .toString() + '\')"' +
                                ' title="Delete">' +
                                '<i class="fas fa-trash"></i>' +
                                '</button>';
                            ...
                            $('#table-sjn').append('<tr><td>' + (key + 1) + '</td><td>' +
                                (value.kode_material ? value.kode_material : '') + '</td><td>' +
                                (value.barang ? value.barang : '') + '</td><td>' +
        ...
        function updateData(formData) {
            ...
            $.ajax({
                url: "{{ url('products/surat_jalan/update_detail') }}", // Ganti URL sesuai dengan endpoint untuk operasi insert
                type: "POST",
                data: formData,
                contentType: false,
                processData: false,
        ...
        function deleteDetail(id, barang) {
            if (confirm('Apakah Anda yakin ingin menghapus item dengan nama komponen: ' + barang + '?')) {
                $.ajax({
                    url: 'detail_surat_jalan/' + id + '/delete',
                    type: 'POST',
                    data: {
                    ...
                    success: function(result) {
                        ...
                        // alert(result.id_pr);
                        $.ajax({
                            url: "{{ url('products/surat_jalan_detail') }}" + "/" + result.id_sjn,
                            type: "GET",
                            dataType: "json",
                            beforeSend: function() {
                                $('#table-sjn').append(
                                ...
                                if (data.sjn.details.length == 0) {
                                    ...
                                    $.each(data.sjn.details, function(key, value) {
                                        ...
                                        var editButton =
                                            ...
                                            .id + '\', \'' +
                                            value.kode_material + '\', \'' + value.barang +
                                            '\', \'' + value
                                            .spek + '\', \'' + value.qty +
                                            '\', \'' + value.satuan + '\', \'' + value
                                            .keterangan +
                                        ...
                                        $('#table-sjn').append('<tr><td>' + (key + 1) +
                                            '</td><td>' + value
                                            .kode_material + '</td><td>' + value
                                            .barang + '</td><td>' +
                                            value.spek + '</td><td>' + value.qty +
                                            '</td><td>' + value
                                            .satuan + '</td><td>' + value.keterangan +
                                            '</td><td>' +
                                            editButton + deleteButton + '</td></tr>');
                                    });
                                }
        ...
        function lihatSJN(data) {
            ...
            $.ajax({
                url: "{{ url('products/surat_jalan_detail') }}" + "/" + data.id,
                type: "GET",
                dataType: "json",
                beforeSend: function() {
                    $('#table-sjn').append('<tr><td colspan="15" class="text-center">Loading...</td></tr>');
                ...
                success: function(data) {
                    ...
                    if (data.sjn.details.length == 0) {
                        ...
                        $.each(data.sjn.details, function(key, value) {
                            ...
                            // $('#table-sjn').append('<tr><td>' + (key + 1) + '</td><td>' + value
                            ...
                            $('#table-sjn').append('<tr><td>' + (key + 1) + '</td><td>' + value
                                .kode_material + '</td><td>' + value.barang + '</td><td>' +
                                value.spek + '</td><td>' + value.qty + '</td><td>' + value
                                .satuan + '</td><td>' + value.keterangan + '</td><td>' +
                                editButton + deleteButton + '</td></tr>');
                        });
                    }
                }
        ...
        function editRow(id, kode_material, barang, spek, qty, satuan, keterangan) {
            console.log(id, kode_material, barang, spek, qty, satuan, keterangan);
            resetForm();
            $('#modal-title').text("Edit Detail");
            $('#button-update-sjn').text("Simpan");
            $('#button-update-sjn').off('click');
            $('#button-update-sjn').on('click', function() {
            ...
            $('#barang').val(barang) // Mengosongkan nilai input dengan ID 'kode_material'
