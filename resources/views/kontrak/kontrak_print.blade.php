        ...
        @foreach ($negos as $neg)
            ...
            <div class="content">
                ...
                <ol>
                    ...
                    <li>Harga tersebut sudah termasuk biaya kirim, asuransi, packing, dan lain-lain sampai ke lokasi PT INKA Multi Solusi Service - Madiun</li>
                    <li>Barang dikirim ke PT IMSS paling lambat {{ $nego->delivery_time }}</li>
                    <li>Masa garansi barang {{$nego->garansi}}</li>
                    <li>Negosiasi ini berlaku {{$nego->validity}}</li>
                    <li>Pembayaran {{$nego->franco }}</li>
                    <li>Termin Pembayaran : TT 30 Hari setelah pekerjaan selesai dan dokumen penagihan diterima dengan benar dan lengkap oleh PT IMSS</li>
                    <li>Jawaban Negosisasi paling lambat tanggal <b style="font-size: 10px">{{ $nego->batas_nego }}</b></li>
                </ol>
            ...
            <div style="margin-left: 70%; width: 50%; margin-top: 5%">
                <table class="w-100">
                    <tr>
                        <td class="text-center" style="text-align: center"><b style="font-size: 10px">PT INKA MULTI SOLUSI SERVICE</b></td>
                    </tr>
                    <tr>
                        <td class="text-center" style="text-align: center"><b style="font-size: 10px">KEPALA DIVISI TEKNIK & LOGISTIK</b></td>
                    </tr>
                    <tr>
                        <td style="height: 70px"></td>
                    </tr>
                    <tr>
                        <td class="text-center" style="text-align: center"><b style="text-decoration: underline; font-size: 10px;">AMRON BAITARRIZAQ</b></td>
                    </tr>
                </table>
            </div>
