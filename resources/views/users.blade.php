            ...
            <div class="card">
                <div class="card-header">
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add-user"
                        onclick="addUser()"><i class="fas fa-plus"></i> Add New User</button>
                </div>
                <div class="card-body">
                            ...
                            @if (count($users) > 0)
                                @foreach ($users as $key => $d)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $data['username'] }}</td>
                                        <td>{{ $role }}</td>
                                        <td class="text-center"><button title="Edit User" type="button"
                                                class="btn btn-success btn-xs" data-toggle="modal" data-target="#add-user"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div>
                            <p>Anda yakin ingin menghapus user <span id="delete_name" class="font-weight-bold"></span>?
                            </p>
                        </div>
                    </div>
                    <div class="modal-footer justify-content-between">
